...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Dashboard / Damage Bill</h1>
  <a href="<?php echo base_url();?>View/damage/list_damage" class="d-none d-sm-inline-block btn btn-sm btn-grad btn-primary shadow-sm"><i class="fas fa-add"></i> List Damage</a>
  </div>
<div class="row">
...
<div class="col-xl-12 col-lg-12">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Damage Bill</h6>
    </div>
    <!-- Card Body -->
    <div class="card-body">
   ...
   <div class="img row" style="width:100%;height:160px;margin-top:20px;">
    ...
    <?php $sales_bill =$this->Admin_model->table_column($tablename='damage',$column='dam_no',$val=$invoice);
    if(count($sales_bill)>0){
        ...
        <div class="row">
            <div class="col-md-6">Damage No : <?php echo $sales_bill_row['dam_no']; ?></div>
   ...
   <div class="bill_table">
    ...
    <tbody>
        ...
        <?php
        $i=1;
        $saled_list=$this->Admin_model->table_column('damage_details',$column='dam_no',$val=$invoice);
