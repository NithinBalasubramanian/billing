...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Dashboard / Supplied Bill</h1>
</div>
<div class="row">
...
<div class="col-xl-12 col-lg-12">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Supplied Bill</h6>
    </div>
    <!-- Card Body -->
    <div class="card-body">
   ...
   <div class="img row" style="width:100%;height:160px;margin-top:20px;">
    ...
    if(count($sales_bill)>0){
        ...
        <div class="row">
            ...
            <?php $cus=$this->Admin_model->table_column('customer','id',$sales_bill_row['customer_id']);
...
<?php $i++;  } } ?>
        ...
        <tr>
            <td colspan="4" rowspan="5">Amount in words :
            <?php
                                $number =  $grand_total; 
                                $no = round($number);
            ...
            <?php $saled_data=$this->Admin_model->table_column('saled_out','invoice_no',$invoice);
            foreach($saled_data as $saled_row){ ?>
            <td colspan="">Grand Total </td>
            <td><?php echo $saled_row['total']; ?></td>
        </tr>
        <?php if($saled_row['damage'] != '0'){  ?>
        <tr>
            <td colspan="">Damage</td>
            <td><b><?php echo $saled_row['damage']; ?></b></td>
        </tr>
        <tr>
            <td colspan="">Grand Total</td>
            <td><b><?php echo $saled_row['grand_total']; ?></b></td>
        </tr>
        <?php } ?>
        <tr>
            <td colspan="">Paid</td>
            <td><b><?php echo $saled_row['paid']; ?></b></td>
        </tr>
        <tr>
            <td colspan="">Due</td>
            <td><b><?php echo $due=$saled_row['grand_total']-$saled_row['paid']; ?></b></td>
        </tr>
        <?php if($saled_row['damage'] == '0'){  ?>
            <tr>
            <td colspan=""></td>
