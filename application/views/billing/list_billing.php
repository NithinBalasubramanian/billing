      ...
      <?php } ?>
               ...
               if(count($customer)){
                   foreach($customer as $customer_row){
                       ...
                       <td><?php echo $billing_row['discount']; ?></td>
                       ...
                       <td><a href="<?php echo base_url();?>index.php/View/billing/pay_balance/<?php echo $billing_row['id'];?>" class="btn btn-sm btn-success">Pay</a></td>
                       <?php  $this->load->library('session');
      $data=$_SESSION['admin'];
      if($data=='admin'||$data=='sub_admin'){
      ?>
