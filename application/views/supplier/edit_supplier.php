...
<div class="col-xl-12 col-lg-7">
  <div class="card shadow mb-4">
    ...
    <!-- Card Body -->
    <div class="card-body">
    <form class="form-horizontal" action="<?php echo base_url('admin/Update_all/supplier/supplier/'.$edit_id.'/edit_supplier/list_supplier'); ?>" method="post" enctype="multipart/form-data" >
              <div class="box-body">
                <?php $customer=$this->CI->table_column_get($tablename='supplier',$column='id',$val=$edit_id);
                if(count($customer)>0){
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="col-sm-12">
                    <input type="text" name="supplier_name" id="" class="form-control" id="inputEmail3" placeholder="Customer Name" value="<?php echo $customer_row['supplier_name']; ?>" required>
                  </div>
                </div>
              </div>
              <div class="row">
                  ...
                  <div class="col-sm-12">
                    <input type="text" name= "supplier_contact" id="" class="form-control" id="inputEmail3" placeholder="Contact" value="<?php echo $customer_row['supplier_contact']; ?>" required>
                  </div>
                </div>
				<div class="form-group col-md-6">
                  ...
                  <div class="col-sm-12">
                    <input type="text" name= "supplier_sec" id="" class="form-control" id="inputEmail3" placeholder="Secondary Number" <?php if($customer_row['supplier_sec'] != '0'){ ?> value="<?php echo $customer_row['supplier_sec']; ?>" <?php } ?>>
                  </div>
                </div>
              </div>
              <div class="row">
              <div class="form-group col-md-6">
                  ...
                  <div class="col-sm-12">
                    <input type="text" name= "due" id="" class="form-control" id="inputEmail3" placeholder="Due Amount" value="<?php echo $customer_row['due']; ?>" required>
                  </div>
                </div>
				        <div class="form-group col-md-6">
