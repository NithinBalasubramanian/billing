...
<div class="col-xl-12 col-lg-12">
  <div class="card shadow mb-4">
   ...
   <div class="img row" style="width:100%;height:auto;margin-top:20px;">
        ...
        <div class="col-md-5 text-right none"> <h5 style="margin-top:30px;"><b>GST INVOICE</b></h5></div>
    ...
    <?php $sales_bill =$this->Admin_model->table_column($tablename='con_sales',$column='invoice_no',$val=$invoice);
   ...
   <div class="bill_table table_responsive">
    ...
    <tbody>
        ...
        <?php
        $i=1;
        $saled_list=$this->Admin_model->table_column('con_sales_details',$column='invoice_no',$val=$invoice);
